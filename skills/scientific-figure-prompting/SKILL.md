...
- For reusable prompt skeletons, figure-type recipes, remote-sensing phrasing, and negative-prompt patterns, read [references/prompt-recipes.md](references/prompt-recipes.md).
